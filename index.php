      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="?page=forgot-password">Forgot Password</a>
    ...
    <?php
      ...
      if ($page == ""){
        ...
        include "cards.php";
          ...
          elseif ($page == "utilities-colors"){
              include "utilities-color.php";
          }elseif ($page == "utilities-border"){
              include "utilities-border.php";
          }elseif ($page == "utilities-animation"){
              include "utilities-animation.php";
          }elseif ($page == "utilities-other"){
